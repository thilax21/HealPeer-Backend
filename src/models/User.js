...
//     pricePerSession: { type: Number, default: 20 }, // in LKR (or currency unit you choose)
//     timezone: { type: String, default: "Asia/Colombo" },
//     bookedSessions: [{ dateTime: Date,bookedSessions: [{ dateTime: Date, client: { type: mongoose.Schema.Types.ObjectId, ref: "User" } }],
