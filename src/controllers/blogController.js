...
// Helper: build base URL (http in dev, https in prod)
const getBaseUrl = (req) => {
  // On Render behind proxy, req.protocol may be "http"
  // so we explicitly force https in production
  const protocol =
